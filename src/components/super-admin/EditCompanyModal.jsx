                                ...
                                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full pl-12 pr-4 py-4 bg-secondary-50 dark:bg-gray-800 border-2 border-secondary-200 dark:border-secondary-200/20 rounded-2xl focus:border-primary-500 dark:focus:border-secondary-200 focus:ring-4 focus:ring-primary-500/20 dark:focus:ring-primary-900/30 outline-none transition-all dark:text-white"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className="w-full px-4 py-4 bg-secondary-50 dark:bg-gray-800 border-2 border-secondary-200 dark:border-secondary-200/20 rounded-2xl focus:border-primary-500 dark:focus:border-secondary-200 focus:ring-4 focus:ring-primary-500/20 dark:focus:ring-primary-900/30 outline-none transition-all dark:text-white"
                                        >
                                    ...
                                    <div className="flex gap-3 pt-4">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="flex-1 py-4 bg-primary-600 dark:bg-primary-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:bg-primary-600 dark:hover:bg-primary-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                        >
