        ...
        if (active && payload && payload.length) {
            ...
            return (
                <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-white/50 dark:border-white/10 p-4 rounded-2xl shadow-2xl ring-1 ring-black/5">
                    <p className="text-sm font-black text-gray-900 dark:text-white mb-1">{data.name}</p>
                    <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-2">{data.description}</p>
                    <div className="flex items-center justify-between gap-4 pt-2 border-t border-gray-100 dark:border-gray-800">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400">Entreprises:</span>
                        <span className="text-sm font-black text-gray-900 dark:text-white">{data.value}</span>
                    </div>
                </div>
            );
        }
