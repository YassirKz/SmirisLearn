        ...
        <div className="space-y-6">
            ...
            <motion.div
                ...
                className={`
                    ...
                    ${dragActive 
                        ? 'border-secondary-200 bg-secondary-50 dark:bg-primary-900/30' 
                        : 'border-gray-300 dark:border-secondary-200/20 hover:border-primary-400 dark:hover:border-secondary-200 hover:bg-secondary-50 dark:hover:bg-gray-800'
                    }
                    ...
                    {!file ? (
                        <>
                            ...
                            <label
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 bg-primary-600 dark:bg-primary-500 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all cursor-pointer"
                            >
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-900 rounded-xl">
                                <FileVideo className="w-8 h-8 text-primary-500 dark:text-primary-500" />
                            ...
                            {uploading && (
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-primary-500 dark:text-primary-500">{progress}%</span>
                                    </div>
                                    <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                        <motion.div
                                            initial={{ width: 0 }}
                                            animate={{ width: `${progress}%` }}
                                            className="h-full bg-gradient-to-r from-secondary-900 to-primary-500"
                                        />
                                    </div>
                                </div>
                            )}
                            ...
                            {!uploading && (
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex-1 px-6 py-3 bg-primary-600 dark:bg-primary-500 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all"
                                    >
