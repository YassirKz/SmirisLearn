        ...
        >
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                    <button
                        type="button"
                        onClick={onDuplicate}
                        className="p-2 bg-white dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-slate-600 rounded-xl transition-all shadow-sm border border-secondary-200 dark:border-gray-600"
                        title="Dupliquer"
                    >
                    ...
                    <button
                        type="button"
                        onClick={onRemove}
                        className="p-2 bg-white dark:bg-slate-700 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl transition-all shadow-sm border border-secondary-200 dark:border-gray-600 hover:border-red-200 dark:hover:border-red-800/50 group/del"
                        title="Supprimer"
                    >
                            ...
                            <div key={optIdx} className="flex items-center gap-3">
                                <div className="flex bg-white dark:bg-slate-900/60 p-2.5 rounded-xl shadow-sm border border-secondary-200 dark:border-slate-700/60 cursor-pointer hover:border-primary-500 dark:hover:border-primary-500 transition-colors">
                                    <input
                                        ...
                                        className="w-5 h-5 text-primary-500 dark:text-primary-500 rounded focus:ring-primary-500 cursor-pointer"
                                    />
                                </div>
                                <input
                                    type="text"
                ...
                <div className="flex gap-4 mb-6 bg-white/50 dark:bg-slate-900/30 p-5 rounded-2xl border border-secondary-200 dark:border-slate-800">
                    <label className="flex-1 flex items-center justify-center gap-3 p-4 bg-white dark:bg-slate-900/60 rounded-xl shadow-sm border border-secondary-200 dark:border-slate-700/60 cursor-pointer hover:border-primary-500 dark:hover:border-primary-500 transition-all font-medium">
                        <input
                            ...
                            className="w-5 h-5 text-primary-500 dark:text-primary-500 focus:ring-primary-500 cursor-pointer"
                        />
            ...
            <div className="mt-4 pt-4 border-t border-secondary-200/50 dark:border-slate-800">
                <button
                    ...
                    className="text-xs font-bold uppercase tracking-wider text-gray-400 hover:text-primary-500 dark:hover:text-primary-500 flex items-center gap-1.5 transition-colors"
                >
