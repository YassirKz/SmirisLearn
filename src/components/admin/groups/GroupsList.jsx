...
export default function GroupsList({ isReadOnly = false, orgId: propOrgId }) {
  ...
  return (
    <div className="space-y-6">
      {/* Barre d'outils */}
      <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-sm rounded-3xl p-5 shadow-lg border border-secondary-200 dark:border-secondary-200/20 relative overflow-hidden">
      ...
      {/* Table */}
      <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-sm rounded-3xl shadow-lg border border-secondary-200 dark:border-secondary-200/20 overflow-hidden transition-all duration-300 relative">
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-16 text-center relative">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                      <div className="w-20 h-20 bg-white/50 dark:bg-slate-900/20 rounded-full flex items-center justify-center mb-4 shadow-inner border border-secondary-200 dark:border-secondary-200/20">
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 rounded-2xl flex items-center justify-center text-primary-500 dark:text-primary-500 shadow-sm border border-secondary-200/50 dark:border-primary-800/30 group-hover/row:scale-105 transition-transform">
                          <Users className="w-6 h-6" />
                        </div>
                        <div>
                          <div className="font-bold text-gray-800 dark:text-gray-200 group-hover/row:text-primary-500 dark:group-hover/row:text-primary-500 transition-colors">
                        ...
                        {!isReadOnly && (
                          <>
                            <motion.button
                              ...
                              className="p-2.5 bg-white/50 dark:bg-slate-900/20 hover:bg-secondary-200 dark:hover:bg-primary-900/50 border border-secondary-200 dark:border-secondary-200/20 hover:border-secondary-200 dark:hover:border-primary-800/50 rounded-xl transition-all text-primary-500 dark:text-primary-500 shadow-sm"
                            ...
                            <motion.button
                              ...
                              className="p-2.5 bg-white/50 dark:bg-slate-900/20 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 border border-secondary-200 dark:border-secondary-200/20 hover:border-emerald-200 dark:hover:border-emerald-800/50 rounded-xl transition-all text-emerald-600 dark:text-emerald-400 shadow-sm"
                            ...
                            <motion.button
                              ...
                              className="p-2.5 bg-white/50 dark:bg-slate-900/20 hover:bg-red-100 dark:hover:bg-red-900/50 border border-secondary-200 dark:border-secondary-200/20 hover:border-red-200 dark:hover:border-red-800/50 rounded-xl transition-all text-red-600 dark:text-red-400 shadow-sm"
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="px-6 py-4 bg-white/40 dark:bg-slate-900/20 border-t border-secondary-200 dark:border-secondary-200/20 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <motion.button
                ...
                className="px-4 py-2 bg-white/50 dark:bg-slate-900/20 border border-secondary-200 dark:border-secondary-200/20 rounded-xl hover:bg-white/80 dark:hover:bg-white/10 disabled:opacity-50 disabled:hover:bg-white/50 dark:disabled:hover:bg-white/5 shadow-sm transition-all font-medium text-gray-700 dark:text-gray-300 text-sm"
              >
                Précédent
              </motion.button>
              <motion.button
