        ...
        return (
            <AdminLayout>
                <div className="min-h-[60vh] flex items-center justify-center">
                    <div className="w-16 h-16 border-4 border-secondary-200 dark:border-primary-800 rounded-full border-t-primary-500-600 animate-spin" />
                </div>
            </AdminLayout>
        );
    }
        ...
        <AdminLayout>
            ...
            >
                ...
                <motion.button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-800/60 shadow-lg backdrop-blur-xl rounded-xl hover:bg-white/80 dark:hover:bg-slate-700/80 transition-all border border-secondary-200 dark:border-secondary-200/20 text-gray-700 dark:text-gray-300 font-medium text-sm"
                >
                ...
                {/* En-tête */}
                <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-lg border border-secondary-200 dark:border-secondary-200/20 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start gap-6">
                        ...
                        <div className="flex gap-2 self-end sm:self-start shrink-0">
                            <motion.button
                                ...
                                className="p-2.5 bg-accent-50 dark:bg-accent-900/20 text-primary-500 dark:text-accent-400 hover:bg-accent-500 text-secondary-900 dark:hover:bg-accent-900/40 rounded-xl transition-colors shadow-sm border border-accent-200/50 dark:border-accent-800/50"
                                title="Modifier"
                            >
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-6 text-xs sm:text-sm font-semibold relative z-10">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/50 dark:bg-slate-900/20 text-gray-600 dark:text-gray-300 shadow-sm border border-secondary-200 dark:border-secondary-200/20">
                        ...
                        {pillar && (
                            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-secondary-50 dark:bg-primary-900/20 text-secondary-900 dark:text-primary-300 shadow-sm border border-secondary-200/50 dark:border-primary-800/50">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex gap-3 shrink-0 w-full sm:w-auto">
                            <motion.button
                                ...
                                className="px-6 py-3 bg-white/80 dark:bg-slate-800/80 text-gray-700 dark:text-gray-200 font-bold rounded-2xl border border-secondary-200 dark:border-secondary-200/20 hover:bg-white dark:hover:bg-slate-700 transition-all shadow-sm flex items-center justify-center gap-2 flex-1 sm:flex-none"
                            >
                            ...
                            <motion.button
                                ...
                                className="group px-6 py-3 bg-primary-600 dark:bg-primary-500 hover:from-primary-500 hover:to-accent-500 text-white rounded-2xl shadow-lg shadow-primary-500/25 hover:shadow-xl hover:shadow-primary-500/40 transition-all flex items-center justify-center gap-3 font-bold border border-secondary-200/30 flex-1 sm:flex-none"
                            >
                    ...
                    {quizzes.length > 0 ? (
                        <div className="space-y-4 relative z-10">
                            {quizzes.map((quiz, idx) => (
                                <div key={quiz.id} className="p-6 bg-white/40 dark:bg-slate-800/40 rounded-2xl border border-secondary-200 dark:border-secondary-200/20 shadow-sm group">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-3 sm:gap-4 text-sm text-gray-600 dark:text-gray-300 flex-wrap">
                                                ...
                                                <div className="flex items-center gap-2 px-4 py-2 bg-white/60 dark:bg-slate-800/60 border border-secondary-200 dark:border-secondary-200/20 rounded-xl font-medium shadow-sm">
                        ...
                        <div className="relative z-10 text-center py-12 px-4 bg-white/40 dark:bg-slate-800/20 rounded-2xl border-2 border-dashed border-secondary-200 dark:border-secondary-200/20">
                    ...
                    {showQuizModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70 backdrop-blur-sm" onClick={() => setShowQuizModal(false)}>
                            <motion.div
                                ...
                                className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl max-w-4xl w-full shadow-2xl border border-secondary-200 dark:border-secondary-200/30 ring-1 ring-black/5 relative overflow-hidden flex flex-col max-h-[90vh]"
                    ...
                    {showLinkModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70 backdrop-blur-sm" onClick={() => setShowLinkModal(false)}>
                            <motion.div
                                ...
                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                exit={{ scale: 0.95, opacity: 0, y: 20 }}
                                className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl max-w-lg w-full shadow-2xl border border-secondary-200 dark:border-secondary-200/30 ring-1 ring-black/5 relative overflow-hidden flex flex-col max-h-[80vh]"
                                onClick={e => e.stopPropagation()}
                            >
                                <div className="relative px-8 pt-8 pb-6 bg-gradient-to-br from-primary-600 to-accent-600 text-white shrink-0">
                                    <div className="flex items-center justify-between">
                                        ...
                                        availableQuizzes.map(q => (
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    disabled={linking}
                                                    className="px-4 py-2 bg-secondary-50 dark:bg-primary-900/30 text-primary-500 dark:text-primary-500 text-sm font-bold rounded-xl hover:bg-secondary-200 dark:hover:bg-primary-900/50 transition-all border border-secondary-200 dark:border-primary-800/50 disabled:opacity-50"
                                                >
                                                    Choisir
                                                </button>
                                            </div>
                    ...
                    {showEditModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70 backdrop-blur-sm" onClick={() => setShowEditModal(false)}>
                            <motion.div
                                ...
                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                exit={{ scale: 0.95, opacity: 0, y: 20 }}
                                className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl max-w-2xl w-full shadow-2xl border border-secondary-200 dark:border-secondary-200/30 ring-1 ring-black/5 relative overflow-hidden flex flex-col max-h-[90vh]"
                                onClick={e => e.stopPropagation()}
                            >
                                {/* En-tête premium */}
                                <div className="relative px-8 pt-8 pb-6 bg-gradient-to-br from-primary-600 to-accent-600 text-white shrink-0">
