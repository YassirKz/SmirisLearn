...
// Barre de progression au scroll (Wow effect)
...
// Arrière-plan Mesh Gradient Animé (Premium)
const MeshGradient = () => (
  <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
    ...
    <motion.div
      ...
      className="absolute top-[20%] left-[30%] w-[40%] h-[40%] bg-purple-600/10 rounded-full blur-[150px]"
    />
  </div>
);
...
export default function LandingPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Oui, nous hébergeons toutes vos vidéos sur des serveurs sécurisés et optimisés pour une lecture fluide partout dans le monde.",
    },
    {
      question: "Puis-je personnaliser les quiz ?",
      answer:
        "Absolument ! Créez des QCM, vrai/faux, avec timer, nombre de tentatives limité, et feedback détaillé pour chaque réponse.",
    },
    {
      question: "Combien de membres puis-je ajouter ?",
      answer:
        "Cela dépend de votre plan. Le plan Starter est gratuit jusqu’à 10 membres, Pro jusqu’à 100, et Enterprise est illimité.",
    },
    {
      question: "Y a-t-il un support technique ?",
      answer:
        "Oui, nous offrons un support par email pour tous les plans, et un support prioritaire avec un account manager dédié pour le plan Enterprise.",
    },
    {
      question: "Mes données sont-elles sécurisées ?",
      answer:
        "La sécurité est notre priorité. Nous utilisons le chiffrement SSL, des politiques RLS (Row Level Security) au niveau de la base de données, et des sauvegardes régulières.",
    },
  ];
  ...
  const validateForm = () => {
    ...
    if (!formData.fullName.trim()) errors.fullName = "Nom requis";
      ...
      errors.fullName = "Minimum 2 caractères";
      ...
      const { error } = await supabase.from("contacts").insert([
        {
          ...
          company_name:
            escapeText(untrusted(formData.companyName.trim())) || null,
  ...
  const handleSignupSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/create-org-and-checkout`,
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      ...
      <Section
        id="hero"
        className="relative transition-all duration-700 overflow-hidden bg-slate-950 min-h-screen flex items-center justify-center pt-0"
      >
        <MeshGradient />
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-full">
              ...
              >
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-6 h-6 rounded-full border-2 border-slate-950 bg-gradient-to-br from-indigo-400 to-purple-400"
                    />
                  ))}
                </div>
              ...
              */}
              ...
              >
                Simplifiez la création de vos parcours pédagogiques. Gérez vos
                vidéos, quiz, et suivez la progression de vos collaborateurs en
                temps réel.
              </motion.p>
          ...
          >
            {[
              ...
              >
                ...
                <div className="text-[10px] sm:text-xs md:text-sm text-gray-400 mt-1 font-medium">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <Section id="features" className="bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 px-4">
            ...
            >
              L'excellence pédagogique <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-500">réinventée.</span>
            </motion.h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
            {/* Bento 1: Piliers (Large) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="relative z-20 max-w-md">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg md:text-xl font-medium leading-relaxed">
                  Structurez vos cours en parcours logiques. Glissez-déposez vos contenus et créez une expérience d'apprentissage fluide.
                </p>
              </div>

              {/* Visual Component: Dynamic Tree */}
              <div className="absolute right-[-5%] bottom-[-10%] md:right-8 md:bottom-12 w-full md:w-[400px] h-full hidden md:flex items-end justify-end">
                <div className="relative w-full h-[80%] flex flex-col gap-4 items-end">
                   {[1, 2, 3].map((i) => (
                     <motion.div
                       key={i}
            ...
            >
              ...
              <div className="relative z-20">
                 <div className="w-12 h-12 bg-white/20 backdrop-blur-xl rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-500">
                    <Video className="w-6 h-6" />
                 </div>
                 <h3 className="text-2xl font-black text-white mb-2">Vidéos interactives</h3>
                 <p className="text-gray-400 font-medium">Lecteur 4K, chapitrage auto et lecture linéaire forcée.</p>
              </div>
            </motion.div>

            {/* Bento 3: Quiz (Regular) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
               ...
               <div className="space-y-2">
                 <h3 className="text-2xl font-black text-gray-900 dark:text-white">Quiz intelligent</h3>
                 <p className="text-gray-600 dark:text-gray-400 font-medium leading-relaxed">Validation immédiate et feedback personnalisé.</p>
               </div>
            ...
            >
               <div className="flex-1 space-y-4 text-center md:text-left relative z-20">
                  ...
                  <h3 className="text-3xl font-black text-white tracking-tight">Analytics en temps réel</h3>
                  <p className="text-indigo-100 text-lg font-medium">Suivez la progression, les scores et l'engagement de chaque apprenant instantanément.</p>
               </div>
                     ...
                     <div className="flex items-end gap-2 h-full"> 
                        {[40, 70, 45, 90, 65, 80, 55].map((h, i) => (
                          <motion.div
                            ...
                            className="flex-1 bg-white/40 rounded-t-lg group-hover:bg-white/60 transition-colors"
                          />
                        ))}
                     </div>
                  </div>
                  {/* Decorative Glow */}
                  <div className="absolute inset-0 bg-white/20 blur-[100px] rounded-full pointer-events-none" />
               </div>
            </motion.div>
          </div>
        </div>
      ...
      <Section
        id="how-it-works"
        className="bg-secondary-50/50 dark:bg-secondary-950/50 relative overflow-hidden"
      >
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              En 3 étapes simples, déployez votre plateforme de formation et
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              ...
              >
                ...
                <div
                  className={`w-20 h-20 mx-auto mb-8 bg-gradient-to-br ${item.color} rounded-3xl flex items-center justify-center shadow-2xl ${item.glow} relative z-10 group-hover:scale-110 transition-transform duration-500`}
                >
                ...
                <div className="mt-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div
                    className={`h-1.5 w-12 mx-auto bg-gradient-to-r ${item.color} rounded-full`}
                  />
                </div>
              </motion.div>
            ))}
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-[10px] font-black rounded-full uppercase tracking-wider">
                  -20%
                </span>
              </div>
            </div>
                  ...
                  {[
                    {
                      ...
                      content:
                        "Smiris Learn a transformé notre façon de former nos équipes. L'interface est intuitive et le suivi des progrès est un vrai plus.",
                      rating: 5,
                      avatar: "M",
                      tag: "ENTREPRISE",
                    },
                    {
                      ...
                      content:
                        "La gestion des groupes et des accès est incroyablement simple. Mes étudiants adorent la clarté des quiz.",
                      rating: 5,
                      avatar: "T",
                      tag: "FORMATION",
                    },
                    {
                      ...
                      content:
                        "Le dark mode est un vrai plus pour nos équipes. Un outil moderne et efficace.",
                      rating: 5,
                      avatar: "S",
                      tag: "PÉDAGOGIE",
                    },
                    {
                      ...
                      role: "CTO, NextGen AI",
                      content:
                        "La sécurité RLS est un atout majeur pour nos données sensibles. Une plateforme solide.",
                      rating: 5,
                      avatar: "K",
                      tag: "TECH",
                    },
                    {
                      ...
                      content:
                        "Design épuré et expérience utilisateur fluide. Exactement ce que nous cherchions.",
                      rating: 5,
                      avatar: "E",
                      tag: "DESIGN",
                    },
                    {
                      ...
                      content:
                        "L'onboarding a été super rapide. Nos formateurs ont pris l'outil en main en moins d'une heure.",
                      rating: 5,
                      avatar: "M",
                      tag: "MANAGEMENT",
                    },
      ...
      <Section id="demo">
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Dashboard, lecteur vidéo, quiz... tout est pensé pour une
              expérience fluide.
            </p>
          </motion.div>
              ...
              {demoImages.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ${
                    activeSlide === i
                      ? "w-12 bg-primary-400 shadow-[0_0_10px_rgba(96,165,250,0.5)]"
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          >
            ...
            <p className="text-xl text-center text-gray-600 dark:text-gray-300 mb-10">
              Une question ? Notre équipe vous répondra dans les plus brefs
              délais.
            </p>
        ...
        <div className="relative">
          <div className="flex animate-marquee whitespace-nowrap gap-16">
            {[
              ...
              <span
                key={i}
                className="text-2xl font-black text-gray-200 dark:text-gray-700 tracking-tight"
              >
                {brand}
              </span>
            ))}
          ...
          >
            ...
            >
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">
                Inscription - Plan{" "}
                {selectedPlan === "free" ? "Gratuit" : "Starter"}
              </h2>
